...
class S {
  ...
  /// `Name must contain from 1 to 50 symbols`
  String get nameMustContainFrom1To50Symbols {
    return Intl.message(
      'Name must contain from 1 to 50 symbols',
      name: 'nameMustContainFrom1To50Symbols',
      desc: '',
      args: [],
    );
  }
  ...
  String get passwordMustContainAtLeast8Symbols {
    return Intl.message(
      'Password must contain at least 8 symbols',
      name: 'passwordMustContainAtLeast8Symbols',
      desc: '',
      args: [],
    );
  }
